  ...
  <div class="row">
    <div class="bgimage"/>
      ...
      <div class="row center">
        <div class="col s12 m12 l12">
        <p style="font-family:'Tangerine';font-size: 50px;color:white ;font-weight: bolder; ">One stop Multi-Purpose Application for handing everything your University</p>
        </div>
      </div>

      <div class="row container center">
       <div class="col s12 m12 l12">
        <a href="details.html" class="waves-effect waves-light btn-large teal darken-3 center"><i class="material-icons left">cloud</i>Know Everything about Eventize!</a>
        </div>
      </div>
