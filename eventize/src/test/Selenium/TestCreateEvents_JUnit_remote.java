...
public class CreateEvents_JUnit_remote {
	private Selenium selenium;

	@Before
	public void setUp() throws Exception {
		selenium = new DefaultSelenium("localhost", 4444, "*chrome", "http://events-2016.appspot.com/");
		selenium.start();
	}

	@Test
	public void testCreateEvents_JUnit_remote() throws Exception {
		selenium.open("/");
