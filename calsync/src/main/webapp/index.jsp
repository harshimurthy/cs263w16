    ...
    <div class="bgimage"/>
      ...
      <a href="#" class="brand-logo" style="font-family:'Tangerine';font-size: 50px;color:white">Eventize!</a>
         ...
         <div class="row center">
          <div class="col s12 m12 l12">
                <p style="font-family:'Tangerine';font-size: 50px;color:#c51162;font-weight: bolder; ">Responsive Multi-Purpose Application for keeping track of all the events at your University</p>
          </div>
          </div>

         <div class="row container center">
          <div class="col s12 m12 l12">
          <a href="information.html" class="waves-effect waves-light btn-large teal darken-3 center"><i class="material-icons left">cloud</i>Know Everything about Eventize!</a>
          </div>
          </div>
          <div class="row container center">
          <div class="col s12 m12 l12">
      ...
      <%
            ...
            if(user==null){ 
                            ...
                            <a href="<%= userService.createLoginURL(request.getRequestURI()) %>" class="teal darken-3 waves-effect waves-light btn-large">
                                <i class="material-icons left">input</i>Login using your gmail account
                           </a>
                    <%
